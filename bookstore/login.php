                    ...
                    <div class="col-lg-7 mt-4 mt-md-0">
                        <ul class="list-inline mb-0 text-lg-end text-center">
                            ...
                            <li class="list-inline-item ms-4">
                                <a href="#!"><img src="images/appbutton/appstore-btn.svg" alt="" style="width: 140px" /></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="images/appbutton/googleplay-btn.svg" alt="" style="width: 140px" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Nov 2024 06:08:47 GMT -->
