            ...
            >
              <div class="col">
                <div
                  ...
                  style="
                    background: url(images/banner/banner-deal.jpg)
                      no-repeat;
                    background-size: cover;
                    height: 470px;
                  "
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <div class="text-center position-relative">
                      <a href="pages/shop-single.html"
                        ><img
                          src="products/product-img-11.jpg"
                          alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"
                      /></a>
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <div class="text-center position-relative">
                      <a href="pages/shop-single.html"
                        ><img
                          src="products/product-img-12.jpg"
                          alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"
                      /></a>
                      <div class="card-product-action">
                    ...
                    <div class="text-small mb-1">
                      <a href="#!" class="text-decoration-none text-muted"
                        ><small>Fruits & Vegetables</small></a
                      >
                    </div>
                    <h2 class="fs-6">
                      <a
                ...
                <div class="card card-product">
                  <div class="card-body">
                    <div class="text-center position-relative">
                      <a href="pages/shop-single.html"
                        ><img
                          src="products/product-img-13.jpg"
                          alt="Grocery Ecommerce Template"
                          class="mb-3 img-fluid"
                      /></a>
                      <div class="card-product-action">
              ...
              <div class="col-lg-6">
                ...
                <div class="product productModal" id="productModal">
                  <div
                    ...
                    style="
                      background-image: url(products/product-single-img-1.jpg);
                    "
                  >
                    <!-- img -->
                    <img
                      src="products/product-single-img-1.jpg"
                      alt=""
                    />
                  </div>
                  <div>
                    <div
                      ...
                      onmousemove="zoom(event)"
                      style="
                        background-image: url(products/product-single-img-2.jpg);
                      "
                    >
                      <!-- img -->
                      <img
                        src="products/product-single-img-2.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  <div>
                    <div
                      ...
                      onmousemove="zoom(event)"
                      style="
                        background-image: url(products/product-single-img-3.jpg);
                      "
                    >
                      <!-- img -->
                      <img
                        src="products/product-single-img-3.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  <div>
                    <div
                      ...
                      onmousemove="zoom(event)"
                      style="
                        background-image: url(products/product-single-img-4.jpg);
                      "
                    >
                      <!-- img -->
                      <img
                        src="products/product-single-img-4.jpg"
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div class="row g-4">
              ...
              <div class="col-6 col-sm-6 col-md-3">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item mb-2">
                    <a href="pages/shop-checkout.html" class="nav-link"
                      >Shop Checkout</a
                    >
                  </li>
                </ul>
            ...
            <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
              <ul class="list-inline mb-0">
                ...
                <li class="list-inline-item">
                  <a href="#!"
                    ><img src="images/payment/amazonpay.svg" alt=""
                  /></a>
                </li>
                <li class="list-inline-item">
                  <a href="#!"
