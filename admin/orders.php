...
try {
    $sql = "SELECT o.*, u.fullname, u.email,
            CASE 
                ...
                WHEN o.status = 'received' THEN 'Đã nhận hàng'
                                                    ...
                                                    <?php foreach ($orders as $order): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                <p><span class="badge <?= $class ?>"><?= htmlspecialchars($order['status_name']) ?></span></p>
                                                                <?php if ($order['status'] === 'received') : ?>
                                                                    <p><span class="small"> <?= date('d/m/Y H:i', strtotime($order['received_at'])) ?></span></p>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
