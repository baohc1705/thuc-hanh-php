...
<p>Gui len server bang phuong thuc GET nen $_POST khong hien chi co mang $_REQUEST</p>
<hr>
<fieldset>
...
<p>Gui len server dang post nen ca $_REQUEST va $_POST deu nhan ket qua</p>
