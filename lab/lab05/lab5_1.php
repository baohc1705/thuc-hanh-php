...
<body>
	...
	<p>Gui len server cac gia tri x, y, z theo phuong thuc get => tao thanh mang $_GET</p>
	<a href="lab5_1.php?x[]=1&x[]=2&y=3">Link 2</a><br>
	<p>Gui len server cac gia tri mang x va gia tri y</p>
	<a href="lab5_1.php?mod=product&ac=detail&id=1">Link 3</a><br>
	<p>Gui len server cac gia tri mod, ac, id</p>
	<a href="lab5_1.php?mod=product&ac=list&name=a&page=2">Link 4</a><br>
	<p>Gui len server cac gia tri mod, ac, name, page trong mang $_GET</p>
	<hr>
	<fieldset>
